...
import com.jowen.smartqa.model.dto.scoringResult.ScoringResultAddRequest;
import com.jowen.smartqa.model.dto.scoringResult.ScoringResultEditRequest;
import com.jowen.smartqa.model.dto.scoringResult.ScoringResultQueryRequest;
import com.jowen.smartqa.model.dto.scoringResult.ScoringResultUpdateRequest;
...
public class ScoringResultController {
    ...
    public BaseResponse<Long> addScoringResult(@RequestBody ScoringResultAddRequest scoringResultAddRequest, HttpServletRequest request) {
        ...
        // 数据校验
        scoringResultService.validScoringResultCreate(scoringResult);
        // todo 填充默认值
    ...
    public BaseResponse<Boolean> updateScoringResult(@RequestBody ScoringResultUpdateRequest scoringResultUpdateRequest) {
        ...
        // 数据校验
        scoringResultService.validScoringResultUpdate(scoringResult);
        // 判断是否存在
