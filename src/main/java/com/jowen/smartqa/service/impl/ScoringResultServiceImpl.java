package com.jowen.smartqa.service.impl;

import cn.hutool.core.collection.CollUtil;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.jowen.smartqa.constant.CommonConstant;
import com.jowen.smartqa.mapper.ScoringResultMapper;
import com.jowen.smartqa.model.dto.scoringResult.ScoringResultQueryRequest;
...
import com.jowen.smartqa.utils.SqlUtils;
...
public class ScoringResultServiceImpl extends ServiceImpl<ScoringResultMapper, ScoringResult> implements ScoringResultService {
    ...
    @Override
    public void validScoringResultCreate(ScoringResult scoringResult) {
        try{
            Objects.requireNonNull(scoringResult);
        }catch (NullPointerException e){
            throw new ConstraintViolationException("参数不能为空", null);
        }
    }

    @Override
    public void validScoringResultUpdate(ScoringResult scoringResult) {
        try{
            Objects.requireNonNull(scoringResult);
        }catch (NullPointerException e){
            throw new ConstraintViolationException("参数不能为空", null);
