package com.jowen.smartqa.model.vo;
...
public class UserAnswerVO implements Serializable {
     ...
     * 评分策略（0-自定义，1-AI）
     */
    private AppScoringStrategyEnum scoringStrategy;
    ...
    public static UserAnswer voToObj(UserAnswerVO userAnswerVO) {
        ...
        AppTypeEnum appType = userAnswerVO.getAppType();
        AppScoringStrategyEnum scoringStrategy1 = userAnswerVO.getScoringStrategy();
        List<String> choices = userAnswerVO.getChoices();
        userAnswer.setAppType(appType == null ? null : appType.getValue());
        userAnswer.setScoringStrategy(scoringStrategy1 == null ? null : scoringStrategy1.getValue());
    ...
    public static UserAnswerVO objToVo(UserAnswer userAnswer) {
        ...
        userAnswerVO.setAppType(AppTypeEnum.getEnumByValue(userAnswer.getAppType()));
        userAnswerVO.setScoringStrategy(AppScoringStrategyEnum.getEnumByValue(userAnswer.getScoringStrategy()));
